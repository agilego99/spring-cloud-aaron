package com.aaron.zuul_demo.util;
...
public class JsonUtils {
    ...
    public static String toJson(Object obj){
        try{
            ...
            throw new RuntimeException("序列化對象【"+obj+"】時出錯", e);
        }
    }
    ...
    public static <T> T toBean(Class<T> entityClass, String jsonString){
        try {
            ...
            throw new RuntimeException("JSON【"+jsonString+"】轉對象時出錯", e);
        }
    }
    
    /**
     * 用於對象通過其他工具已轉為JSON的字符形式，這裡不需要再加上引號
     * @param obj
     * @param isObject
     */
