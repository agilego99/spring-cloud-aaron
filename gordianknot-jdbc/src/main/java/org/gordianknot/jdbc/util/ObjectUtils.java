...
public abstract class ObjectUtils {
 	...
 	*/
 	...
 	/**
 	* 如果一個對象的封裝類型為null時，將其設為簡單類型的默認值
 	* 目的：當數據庫中字段的值為null時，我們的Bean中的封裝類型被設為null，但是,
 	* 我們可能要對這些封裝類型進行計算，如果一個個的判斷它們是否為null，將是一件
 	* 痛苦的事，這時我們希望當它們為null時，能將它們轉換為簡單類型的默認值
 	* 比如Integer i = null ，我們希望它為0
 	* 轉換規則：Integer 0,Float 0F,Double 0D
 	* <b>轉換不包含繼承的屬性<b/>
 	* @param o
 	*/
 	...
 	/**將一個Object轉換為String
 	* 如果parseColl為false,則不對集合類型的字段作處理
 	* @param o 要toString的對象
 	* @param parseColl 是否處理對象集合屬性
 	*/
