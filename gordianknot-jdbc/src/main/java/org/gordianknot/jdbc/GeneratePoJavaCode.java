...
import org.gordianknot.jdbc.util.StringUtils;
/**
 * 根據表結構生成對應的PO
 */
 	...
 	public void generate(Connection conn, String pack, String author, String savePath) {
 		...
 		try {
 			...
 			while (rs.next()) {
 				...
 				sbpackage.append("import org.gordianknot.jdbc.annotation.Field;\r\n");
 				sbpackage.append("import org.gordianknot.jdbc.annotation.TableName;\r\n");
 				...
 				while (crs.next()) {
 					...
 					if (columnname.equals("id")) {
 						sbpackage.append("import org.gordianknot.jdbc.annotation.AutoId;\r\n");
 						sb.append("\t\t@AutoId\r\n");
