package org.gordianknot.conf.web.filter;
...
public class HTTPBasicAuthorizeFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		req.setAttribute("projectName", System.getProperty(Constant.SMCONF_PROJECT_NAME) == null ? "戈迪安繩結" : System.getProperty(Constant.SMCONF_PROJECT_NAME));
