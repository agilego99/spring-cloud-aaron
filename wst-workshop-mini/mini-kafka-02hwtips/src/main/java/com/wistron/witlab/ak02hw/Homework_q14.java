...
/**
 * Tips:
 * 由於14題主要是By每一個unique的商品貨物編號算出它的count,我們可以利用一個“Map(key是part_no, value是record count)"
 * 的資料容器物件來快速達成目的。
 */
public class Homework_q14 {
    ...
    public static void main(String[] args) {
        ...
        // 產生一個Map: key是part_no, value是record count <---- 存放 “題目#14” 答案的容器
        Map<String, Integer> parts_transCount = new HashMap<>();
        ...
        try {
            ...
            while (true) {
                ...
                for (ConsumerRecord<String, String> record : records){
                    ...
                    // ** “題目#14” 的主要邏輯 **
                    // 把“商品貨物編號”與“計數"放進一個Map(key是part_no, value是record count)的容器中
                    ...
                    //檢查看Map中是否存在msgKey
                    if(parts_transCount.containsKey(msgKey)){
                        // 把之前的筆數拿回來, 加1之後再放去
                        int transCount = parts_transCount.get(msgKey);
                        parts_transCount.put(msgKey, transCount+1);
                    } else {
                        // 這是第1筆, 所以”計數"的初始值為1
                        parts_transCount.put(msgKey, 1);
                    }
                ...
                // 打印出最更新的結果 <---- “題目#14” 的答案
                System.out.println("Parts trans_count: " + mapToString(parts_transCount));
